...
because all of them treat the _file_ as the unit. Treating the _shabad_ as the unit is
...
_Companion document: [PRD.md](PRD.md). Source-of-truth API reference: [sgpc-api.md](sgpc-api.md)._
