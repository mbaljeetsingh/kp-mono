...
export function artworkFor(name: string): Artwork {
  ...
  // roughly one name in seven, "Sri Harmandir Sahib" among them.
  ...
  return {
    backgroundImage: `linear-gradient(${angle}deg, ${colors[0]} 0%, ${colors[1]} 55%, ${colors[2]} 100%)`,
    colors,
    angle,
    initials: name
